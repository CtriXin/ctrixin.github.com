  ...
  function center(number){
	...
	var owl = $(".gallery");
	  ...
	  owl.owlCarousel({
		  ...
		  navigation : true,
		  navigationText : ['<i class="fa fa-4x fa-angle-left"></i><span><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>','<i class="fa fa-4x  fa-angle-right"></i>'],
	  });
	...
	$("#quote").owlCarousel({
		...
		singleItem:true,
		navigation : true,
		navigationText : ['<i class="fa fa-3x fa-angle-left"></i><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>','<i class="fa fa-3x  fa-angle-right"></i>'],
	});
