...
*/
	...
	//判断是.还是#，使用不同的方法获取对象
	if (sDom.charAt(0) == ".") {
		var oWrap = document.getElementById("slider");
...
function fnLoad() {
	...
	function scrollFunc(e) {
		var e = e || event;
		var wrapTop = 60 - document.getElementById("slider").offsetTop;
		var direct;
		var endWrapTop;
	...
	window.onscroll = function() {
		...
		// }
		endTop = top;
		//$slider.css({"top": -top2+60});
		var wrapTop = top*(line.lineHeight + 60 - windowHeight)/((line.lineHeight + 60) * line.scrollRatio - windowHeight);//内容改变top值

		//$slider.css({"top": -wrapTop+60});
		$slider.stop().animate({"top": -wrapTop+60}, 1300);//#wrap 滚动
		//$slider.stop().animate({"top": -wrapTop+60},{queue:false, duration: 1100});
...
function boxGoIn_1() {
	...
	$(".b1_03").stop().animate({top: 135, opacity: 1}, 1200, function() {
...
function boxGoIn_5() {
	...
	$(".b5_ico01").stop().animate({left: 440, top: -10, opacity: 1}, 1000);
	$(".b5_ico02").stop().animate({left: 660, top: -10, opacity: 1}, 1000);
	$(".b5_ico03").stop().animate({left: 440, top: 165, opacity: 1}, 1000);
	$(".b5_ico04").stop().animate({left: 660, top: 165, opacity: 1}, 1000);
	$(".b5_ico05").stop().animate({left: 440, top: 340, opacity: 1}, 1200);
	$(".b5_ico06").stop().animate({left: 220, top: 135, opacity: 1}, 1200);
	$(".b5_ico07").stop().animate({left: 440, top: 135, opacity: 1}, 1200);
	$(".b5_ico08").stop().animate({left: 660, top: 135, opacity: 1}, 1200);
	$(".b5_ico09").stop().animate({left: 0, top: 310, opacity: 1}, 1200);
	$(".b5_ico10").stop().animate({left: 220, top: 310, opacity: 1}, 1200);
	$(".b5_ico11").stop().animate({left: 440, top: 310, opacity: 1}, 1200);
	$(".b5_ico12").stop().animate({left: 660, top: 310, opacity: 1}, 1200);
}
function boxGoOut_5() {
	box5In = true;
	$(".b5_tl, .b5_txt").stop().animate({opacity: 0}, 600);
	$(".b5_01").stop().animate({opacity: 0}, 400);
	$(".b5_ico01").stop().animate({left: 0, top: 165, opacity: 0}, 500);
	$(".b5_ico02").stop().animate({left: 220, top: 165, opacity: 0}, 500);
	$(".b5_ico03").stop().animate({left: 440, top: 165, opacity: 0}, 500);
	$(".b5_ico04").stop().animate({left: 660, top: 165, opacity: 0}, 500);
	$(".b5_ico05").stop().animate({left: 0, top: 0, opacity: 0}, 600);
	$(".b5_ico06").stop().animate({left: 220, top: 0, opacity: 0}, 600);
	$(".b5_ico07").stop().animate({left: 440, top: 0, opacity: 0}, 600);
	$(".b5_ico08").stop().animate({left: 660, top: 0, opacity: 0}, 600);
	$(".b5_ico09").stop().animate({left: 0, top: 0, opacity: 0}, 600);
	$(".b5_ico10").stop().animate({left: 220, top: 0, opacity: 0}, 600);
	$(".b5_ico11").stop().animate({left: 440, top: 0, opacity: 0}, 600);
	$(".b5_ico12").stop().animate({left: 660, top: 0, opacity: 0}, 600);
}
